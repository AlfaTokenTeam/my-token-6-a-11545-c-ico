...
import "./MyToken6A11545C.sol";

contract MyToken6A11545CPreSale {
    MyToken6A11545C public token;
    ...
    function MyToken6A11545CPreSale(
        MyToken6A11545C _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken6A11545C(_token);
